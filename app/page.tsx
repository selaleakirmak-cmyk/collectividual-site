    ...
    <>
      ...
      <section className="poster-section border-b border-[var(--border)]">
        <Container className="grid gap-10 md:grid-cols-[0.85fr_1.15fr] md:items-center">
          <div>
            <p className="poster-kicker mb-6">Free starter tool from the project</p>
            <h2 className="poster-title poster-title--medium">
          ...
          <div>
            <p className="text-[15px] leading-8 text-[var(--muted)] md:text-[17px] md:leading-9">
              A practical first step from Good Intentions Are Not Enough: five tools for ordinary support moments where care needs language, limits, and a next step.
            </p>
            <p className="mt-4 text-[15px] leading-8 text-[var(--muted)] md:text-[17px] md:leading-9">
              Get the toolkit by email. Use it slowly. It is an entry point into the wider project — not a replacement for therapy, diagnosis, or crisis support.
            </p>
            <div className="mt-7 flex flex-wrap gap-4">
