    ...
    <>
      ...
      <section className="poster-section border-b border-[var(--border)]">
        <Container className="grid gap-10 md:grid-cols-[0.85fr_1.15fr] md:items-center">
          <div>
            <p className="poster-kicker mb-6">Projenin ücretsiz başlangıç aracı</p>
            <h2 className="poster-title poster-title--tr-medium">
          ...
          <div>
            <p className="text-[15px] leading-8 text-[var(--muted)] md:text-[17px] md:leading-9">
              İyi Niyet Yetmez projesinden pratik bir ilk adım: bakımın dile, sınıra ve sonraki adıma ihtiyaç duyduğu gündelik destek anları için beş araç.
            </p>
            <p className="mt-4 text-[15px] leading-8 text-[var(--muted)] md:text-[17px] md:leading-9">
              Toolkit’i e-posta ile alın. Yavaş kullanın. Bu daha geniş projenin giriş kapısıdır; terapi, tanı koyma veya kriz desteğinin yerine geçmez.
            </p>
            <div className="mt-7 flex flex-wrap gap-4">
